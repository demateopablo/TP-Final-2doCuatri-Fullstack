...
export class Ruleta extends Juego{
    ...
    jugar(jugador: Jugador): void {
        ...
        if(super.jugadorApto(jugador.getMonedero(),this.apuestaMin)){
            ...
            let numAzar: number;
            let docena: number = 12;
            let paresImpares: number = 18;
            switch(numApuesta){
                case 1: numAzar = this.opcion.generarNumeroAleatorio();
                    ...
                    break;
                case 2: numAzar = this.opcion.generarNumeroAleatorio();
                    this.descontarSaldoPorFicha(paresImpares);
                ...
                case 3: numAzar = this.opcion.generarNumeroAleatorio();
                    ...
                    break;
                case 4: numAzar = this.opcion.generarNumeroAleatorio();
                    ...
                    break;
                case 5: numAzar = this.opcion.generarNumeroAleatorio();
                    this.descontarSaldoPorFicha(docena);
                    ...
                    break;
                case 6: numAzar = this.opcion.generarNumeroAleatorio();
                    this.descontarSaldoPorFicha(docena);
                    ...
                    break;
                case 7: numAzar = this.opcion.generarNumeroAleatorio();
                    this.descontarSaldoPorFicha(docena);
    ...
    descontarSaldoPorFicha(cantNums: number): void{
    ...
    private imprimirGanador(numAzar: number): void{
        ...
        console.log(this.jugador.getMonedero());
    }
    ...
    controlDeRepeticiones(conjuntoDePlenos:number[],numAzar:number): number{
        let contador = 0;
    ...
    elegirNumeroDePlenos(conjuntoDePlenos:number[]):void{
    ...
    compararParesImpares(numAzar:number): number{
        let resto = numAzar % 2;
        return resto;
    }

    compararNumeros(arr: number[], numAleatorio:number): boolean{
    ...
    pagarPleno(valorFicha: number): void{
